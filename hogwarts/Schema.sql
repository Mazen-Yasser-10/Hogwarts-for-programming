...
ADD FOREIGN KEY (`house_id`) REFERENCES `Houses` (`id`) ON DELETE CASCADE;
ALTER TABLE `Students`
ADD FOREIGN KEY (`wand_id`) REFERENCES `Wands` (`id`) ON DELETE CASCADE;
ALTER TABLE `House_Points_Log`
ADD FOREIGN KEY (`student_id`) REFERENCES `Students` (`id`) ON DELETE CASCADE;
ALTER TABLE `House_Points_Log`
ADD FOREIGN KEY (`house_id`) REFERENCES `Houses` (`id`) ON DELETE CASCADE;
ALTER TABLE `Courses`
ADD FOREIGN KEY (`professor_id`) REFERENCES `Professors` (`id`) ON delete cascade;
ALTER TABLE `Challenges`
ADD FOREIGN KEY (`course_id`) REFERENCES `Courses` (`id`) ON delete cascade;
ALTER TABLE `Student_Challenge_Attempts`
ADD FOREIGN KEY (`student_id`) REFERENCES `Students` (`id`) ON DELETE CASCADE;
ALTER TABLE `Student_Challenge_Attempts`
ADD FOREIGN KEY (`challenge_id`) REFERENCES `Challenges` (`id`) ON DELETE CASCADE;
ALTER TABLE `Student_Items`
ADD FOREIGN KEY (`student_id`) REFERENCES `Students` (`id`) ON DELETE CASCADE;
ALTER TABLE `Student_Items`
ADD FOREIGN KEY (`item_id`) REFERENCES `Diagon_Alley` (`item_id`) ON DELETE CASCADE;
ALTER TABLE `Student_Courses`
ADD FOREIGN KEY (`student_id`) REFERENCES `Students` (`id`) ON DELETE CASCADE;
ALTER TABLE `Student_Courses`
ADD FOREIGN KEY (`course_id`) REFERENCES `Courses` (`id`) ON DELETE CASCADE;
-- Insert Data
INSERT INTO Wands (wood, core)
VALUES ('Holly', 'Phoenix Feather'),
  ('Yew', 'Phoenix Feather'),
  ...
  ('Cedar', 'Unicorn Hair');
INSERT INTO Houses (house_name, total_points, house_description)
VALUES ('Gryffindor', 0, 'Bravery and chivalry.'),
  ('Slytherin', 0, 'Ambition and resourcefulness.'),
  ('Hufflepuff', 0, 'Loyalty and hard work.'),
  ('Ravenclaw', 0, 'Wisdom and creativity.');
INSERT INTO Professors (username, email, hashedPassword, role)
VALUES (
    'dumbledore',
...
VALUES (
    ...
    'Learn to defend against dark magic.',
    3
  ),
  ('Potions', 'Master potion-making.', 3),
  (
    'Transfiguration',
    'Change objects into different forms.',
    2
  );
...
VALUES (
    ...
    '2025-03-01 10:00:00',
    '2025-03-05 23:59:59',
    'Test knowledge of dark creatures.'
  );
INSERT INTO Student_Challenge_Attempts (student_id, challenge_id, score)
VALUES (1, 1, 10),
  (2, 1, 15);
INSERT INTO House_Points_Log (student_id, house_id, points_change, reason)
VALUES (1, 1, 50, 'Winning the House Cup');
INSERT INTO Diagon_Alley (item_name, item_price)
VALUES ('Wand Holster', 12.50),
  ('Spellbook', 15.00);
INSERT INTO Student_Items (student_id, item_id, quantity, total_price)
VALUES (1, 1, 1, 12.50),
  (2, 2, 2, 30.00);